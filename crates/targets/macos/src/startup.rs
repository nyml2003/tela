...
pub fn start(options: PlatformLaunchOptions) -> Result<StartupWorker, String> {
    ...
    if options.verbose {
        eprintln!(
            "tela-macos-host: startup index={} cache={}",
